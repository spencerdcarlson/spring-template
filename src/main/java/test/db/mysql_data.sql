...
VALUES (1, 'opA', 'opA//opB', 'This is question 1//question 1', 4, 'II');
INSERT INTO `reading_writing_center`.`question` 
(`question_id`, `question_answer`, `question_options`, `question_txt`, `section_id`, `reference`) 
VALUES (2, 'option2', 'option 1//option 2', 'This is question 2//question 2', 4, 'IV');
INSERT INTO `reading_writing_center`.`question` 
(`question_id`, `question_answer`, `question_options`, `question_txt`, `section_id`, `reference`) 
VALUES (3, 'at', 'by//at', 'This is question 3//question 3', 5, 'VII');
INSERT INTO `reading_writing_center`.`question` 
(`question_id`, `question_answer`, `question_options`, `question_txt`, `section_id`, `reference`) 
VALUES (4, 'yahoo', 'yeah//yahoo', 'This is question 4//question 4', 5, 'V');
...
INSERT INTO `reading_writing_center`.`resource` (`resource_name`, `section_id`) VALUES ('1A-3', 2);
